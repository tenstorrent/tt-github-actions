...
class TestCheckLicenseHeaders(unittest.TestCase):
    ...
    def test_fixture_files_have_correct_format(self):
        ...
        for filename in py_files:
            ...
            self.assertEqual(blank_line, "#", 
                            f"File {filename} should have blank comment line (just '#') after first SPDX line")
        ...
        for filename in cpp_files:
            ...
            self.assertEqual(first_spdx_idx, 0, 
                            f"File {filename} should have SPDX header starting at line 0 (beginning of file)")
    ...
    def test_normalize_line(self):
        ...
        self.assertEqual(normalize_line("# SPDX-FileCopyrightText: © 2025 Tenstorrent AI ULC"), 
                         "# SPDX-FileCopyrightText: © <YEAR> Tenstorrent AI ULC")
        
        # Test without year normalization
        self.assertEqual(normalize_line("# SPDX-FileCopyrightText: © 2025 Tenstorrent AI ULC", False), 
                         "# SPDX-FileCopyrightText: © 2025 Tenstorrent AI ULC")
        ...
        self.assertEqual(normalize_line("# SPDX-FileCopyrightText: © 2025 Tenstorrent AI ULC", True, "2023"), 
                         "# SPDX-FileCopyrightText: © 2025 Tenstorrent AI ULC")
